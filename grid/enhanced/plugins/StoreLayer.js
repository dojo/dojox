dojo.provide("dojox.grid.enhanced.plugins.StoreLayer");
// summary:
...
(function(){
	...
	ns.wrap = function(/* Read-store */store,/* _StoreLayer */layer){
		// summary:
	...
	var unwrap = function(/* string? */layerName){
		// summary:
	...
	var forEachLayer = function(callback, isInnerToOuter){
		// summary:
...
=====*/
		...
		_wrap: function(store, nextLayer){
			// summary:
			...
			//		The store to be wrapped.
			this._store = store;
			var fetchFunc = dojo.hitch(this, function(userRequest){
				return (this.enabled() ? dojo.hitch(this, this._fetch) 
			...
			if(nextLayer){
				...
				this._originFetch = store.fetch;
				store.fetch = fetchFunc;
			}
		...
		_unwrap: function(nextLayer){
			...
			if(nextLayer){
				...
				this._store.fetch = this._originFetch;
			}
			this._originFetch = null;
			this._store = null;
		},
		...
		_fetch: function(/* keywordArgs */userRequest){
			// summary:
			//		The layer specific version of the *fetch* function in dojo.data.api.Read.
			// tags:
			//		protected extension
			throw new Error("_StoreLayer._fetch: unimplemented interface.");
		},
		originFetch: function(/* keywordArgs */userRequest){
