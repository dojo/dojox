...
var layout = [
	[{//--------------------------------------------------------------------------0
		...
		cells:
		[
			{ field: "id", name:"Index", datatype:"number", width: 3},
			{ field: "Genre", name:"Genre", datatype:"string", width: 5/*, notselectable: true*/},
			{ field: "Artist", name:"Artist", datatype:"string", width: 5},
			{ field: "Year", name:"Year", datatype:"number", width: 3},
			{ field: "Album", name:"Album", datatype:"string", width: 9},
...
//				}
			...
			{ field: "Download Date", name:"Download Date", datatype:"date", width: 6, 
			...
			{ field: "Checked", name:"Checked (Customized Label)", editable: false, datatype:"boolean", width: "100%", dataTypeArgs: {
...
//			{ field: "Last Played", name:"Last Played(11)", width: "5px"}
			...
			{ field: "id", name:"Index(1)"},
			{ field: "Genre", name:"Genre(2)"},
			{ field: "Artist", name:"Artist(3)"},
			{ field: "Year", name:"Year(4)"},
			{ field: "Album", name:"Album(5)"},
			{ field: "Name", name:"Name(6)"},
			{ field: "Length", name:"Length(7)"},
			{ field: "Track", name:"Track(8)"},
			{ field: "Composer", name:"Composer(9)"},
			{ field: "Download Date", name:"Download Date(10)", cellFormatter: {
				selector: "date",
				parse: {datePattern: "yyyy/M/d"},
				format:{datePattern: "MMMM d, yyyy"}
			}},
			{ field: "Last Played", name:"Last Played(11)"}
		]]
	}],
	[//--------------------------------------------------------------------------2
		{//first view
