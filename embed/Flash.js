		...
		*/
		...
		fMarkup = function(kwArgs){
			...
			var s = '<embed type="application/x-shockwave-flash" '
				...
				+ 'height="' + htmlEscape(String(kwArgs.height)) + '"'
				+ ((kwArgs.style)?' style="' + htmlEscape(String(kwArgs.style)) + '" ':'')
				+ 'swLiveConnect="'+htmlEscape(String(kwArgs.swLiveConnect))+'" '
				+ 'allowScriptAccess="' +htmlEscape(String(kwArgs.allowScriptAccess))+  '" '
				+ 'allowNetworking="' +htmlEscape(String(kwArgs.allowNetworking))+  '" '
