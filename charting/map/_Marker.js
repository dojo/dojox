dojo.provide("dojox.charting.map._Marker");
dojo.require("dojox.charting.map.Tooltip");

dojo.declare("dojox.charting.map._Marker", 
	null, 
	{
	...
	show: function(featureId){
		...
		dojox.charting.map.showTooltip(this.markerText, this.currentFeature.shape, "before");
	},
	hide: function(){
		dojox.charting.map.hideTooltip(this.currentFeature.shape);
	},
