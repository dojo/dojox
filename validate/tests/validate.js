...
dojo.require("dojox.validate.de");
dojo.require("dojox.validate.jp");
...
tests.register("dojox.validate.tests.validate",
	...
	},
	{
		...
		runTests: function(tests) {
			//test default
			tests.t(dojox.validate.isInteger('0'));
			tests.t(dojox.validate.isInteger('+0'));
			tests.t(dojox.validate.isInteger('-1'));
			tests.t(dojox.validate.isInteger('123456789'));
			tests.f(dojox.validate.isInteger('0123456789'));
			tests.f(dojox.validate.isInteger('00'));
			tests.f(dojox.validate.isInteger('1.0'));
		
			//test separator
			tests.t(dojox.validate.isInteger('10,000,000', {separator: ","} ));
			tests.t(dojox.validate.isInteger('100,000,000', {separator: ","} ));
			tests.t(dojox.validate.isInteger('1,000,000,000', {separator: ","} ));
			tests.t(dojox.validate.isInteger('1.000.000', {separator: "."} ));
			tests.t(dojox.validate.isInteger('10.000.000', {separator: "."} ));
			tests.t(dojox.validate.isInteger('100.000.000', {separator: "."} ));
			tests.f(dojox.validate.isInteger('10.000.000.000', {} ));
			tests.t(dojox.validate.isInteger('10,000,000', {separator: ["", ","]} ));
			tests.t(dojox.validate.isInteger('10000000', {separator: ["", ","]} ));
			tests.f(dojox.validate.isInteger('10.000.000', {separator: ["", ","]} ));
		
			//test sign
			tests.f(dojox.validate.isInteger( '+10000000', {signed: false} ));
			tests.f(dojox.validate.isInteger( '10000000', {signed: true} ));
		}
	},
	{
		name: "isRealNumber",
		runTests: function(tests) {		
			// test default
			tests.t(dojox.validate.isRealNumber('0'));
			tests.t(dojox.validate.isRealNumber('+0'));
			tests.t(dojox.validate.isRealNumber('-1'));
			tests.t(dojox.validate.isRealNumber('123456789'));
			tests.f(dojox.validate.isRealNumber('0123456789'));
			tests.f(dojox.validate.isRealNumber('00'));
			tests.t(dojox.validate.isRealNumber('1.0'));
			tests.t(dojox.validate.isRealNumber('0.0000'));
			tests.f(dojox.validate.isRealNumber('1.'));
			tests.t(dojox.validate.isRealNumber('1234.0012340e63'));
			tests.t(dojox.validate.isRealNumber('1234.0012340e+63'));
			tests.t(dojox.validate.isRealNumber('1234.0012340e-63'));
			tests.f(dojox.validate.isRealNumber('1234.0012340e063'));
			tests.f(dojox.validate.isRealNumber('1234.0012340e63.5'));
			tests.f(dojox.validate.isRealNumber('01234.0012340e10'));
		
			//test separator
			tests.t(dojox.validate.isRealNumber( '10,000,000.12345e-5', {separator: ","} ));
		
			//test decimal
			tests.t(dojox.validate.isRealNumber( '10.000.000,12345e-5', {separator: ".", decimal: ","} ));
		
			//test places
			tests.t(dojox.validate.isRealNumber( '100.25', {places: 2} ));
			tests.t(dojox.validate.isRealNumber( '0.25', {places: 2} ));
			tests.t(dojox.validate.isRealNumber( '.25', {places: 2} ));
			tests.f(dojox.validate.isRealNumber( '100.2', {places: 2} ));
			tests.f(dojox.validate.isRealNumber( '100.250', {places: 2} ));
		
			//test exponent part
			tests.t(dojox.validate.isRealNumber( '100.25e32', {exponent: true} ));
			tests.f(dojox.validate.isRealNumber( '100.25e32', {exponent: false} ));
			tests.t(dojox.validate.isRealNumber( '100.25', {exponent: false} ));
			tests.f(dojox.validate.isRealNumber( '100.25e32', {eSigned: true} ));
			tests.f(dojox.validate.isRealNumber( '100.25+e32', {eSigned: false} ));
                }
	},
	{
		name: "isCurrency",
		runTests: function(tests) {		
			// Austria
			tests.t(dojox.validate.isCurrency('\u20AC 123.456.789,00',  {separator: ".", decimal: ",", symbol:"\u20AC"} ));
			// Germany
			tests.t(dojox.validate.isCurrency('123.456.789,00 \u20AC',  {separator: ".", decimal: ",", symbol:"\u20AC", placement:"after"} ));
			// Switzerland
			tests.t(dojox.validate.isCurrency("SFr. 123'456'789.00",  {separator: "'", symbol:"SFr."} ));
			// Estonia
			tests.t(dojox.validate.isCurrency('123 456 789.00 kr', {separator:" ", symbol:"kr", placement:"after"} ));
			// Hungary
			tests.t(dojox.validate.isCurrency('123 456 789,00 Ft', {separator:" ", decimal: ",", symbol:"Ft", placement:"after"} ));
			// Iceland
			tests.t(dojox.validate.isCurrency('123.456.789,00 kr.', {separator:".", decimal: ",", symbol:"kr.", placement:"after"} ));
			// Indoneasia
			tests.t(dojox.validate.isCurrency('Rp123.456.789', {separator:".", fractional: false, symbol:"Rp"} ));
			// Japan
			tests.t(dojox.validate.isCurrency('\u00a5123,456,789', {fractional: false, symbol:"\u00a5"} ));
			// Kazakh
			tests.t(dojox.validate.isCurrency('-T123 456 789-00', {separator:" ", decimal: "-", symbol:"T"} ));
			// Peru
			tests.t(dojox.validate.isCurrency('S/. 123,456,789.00', { symbol:"S/."} ));
                }
	},
	{	
		name: "isUsCurrency",
		runTests: function(tests) {		
			tests.t(dojox.validate.us.isCurrency('$1,000'));
			tests.t(dojox.validate.us.isCurrency('$1,000.25'));
			tests.t(dojox.validate.us.isCurrency('+$1,000,000'));
			tests.t(dojox.validate.us.isCurrency('- $10,000,000'));
			tests.t(dojox.validate.us.isCurrency('$100,000,000'));
			tests.f(dojox.validate.us.isCurrency('$1000.25', {}));
			tests.t(dojox.validate.us.isCurrency('$1000.25', {separator: ""}));
			tests.f(dojox.validate.us.isCurrency('1,000.25', {}));
			tests.t(dojox.validate.us.isCurrency('1,000.25', {symbol: ["", "$"]}));
			tests.f(dojox.validate.us.isCurrency('1,000.25', {symbol: ["?", "$"]})); //FIXME
			tests.t(dojox.validate.us.isCurrency('1000.25', {symbol: "", separator: ""}));
			tests.f(dojox.validate.us.isCurrency('$1,000.25', {fractional: false}));
			tests.f(dojox.validate.us.isCurrency('$1,000.25', {signed: true}));
			tests.f(dojox.validate.us.isCurrency('-$1,000.25', {signed: false}));
                }
	},
	{
		name: "isDeCurrency",
		runTests: function(tests) {
			tests.t(dojox.validate.isGermanCurrency('1.000 \u20AC'));
			tests.t(dojox.validate.isGermanCurrency('1.000,25 \u20AC'));
			tests.t(dojox.validate.isGermanCurrency('+1.000.000 \u20AC'));
			tests.t(dojox.validate.isGermanCurrency('-10.000.000 \u20AC'));
			tests.t(dojox.validate.isGermanCurrency('100.000.000 \u20AC'));
			tests.f(dojox.validate.isGermanCurrency('1000,25 \u20AC'));
			tests.f(dojox.validate.isGermanCurrency('1.000,25'));
		}
	},
	{
		name: "isJpCurrency",
		runTests: function(tests) {
			tests.t(dojox.validate.isJapaneseCurrency('\u00a51,000'));	
			tests.f(dojox.validate.isJapaneseCurrency('\u00a51,000.25'));
			tests.t(dojox.validate.isJapaneseCurrency('+\u00a51,000,000'));
			tests.t(dojox.validate.isJapaneseCurrency('- \u00a510,000,000'));
			tests.t(dojox.validate.isJapaneseCurrency('\u00a5100,000,000'));
			tests.f(dojox.validate.isJapaneseCurrency('\u00a51000'));
		}
	},
	{	
