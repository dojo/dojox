define([
	...
	// The doc above is copied from _compat.js. Currently, the new doc tool has a bug
	// which prevents the doc of a module (not a class) from being included. We should
	// remove the doc from _compat.js when it will become clear how the API doc tool works. 
