define(["doh/runner", "dojo/sniff", "require"], function(doh, has, require){
	try{
		...
		doh.registerUrl("dojox.mobile.tests.doh.DatePickerIso", require.toUrl("./DatePickerIso.html"),999999);
		...
		doh.registerUrl("dojox.mobile.tests.doh.IconContainer", require.toUrl("./View.html"),999999);
		doh.registerUrl("dojox.mobile.tests.doh.RoundRectList", require.toUrl("./RoundRect.html"),999999);
		...
		doh.registerUrl("dojox.mobile.tests.doh.FilteredListTests", require.toUrl("./FilteredListTests.html"),999999);
		doh.registerUrl("dojox.mobile.tests.doh.TemplatedWidgetsTests", require.toUrl("./TemplatedWidgetsTests.html"),999999);
		doh.registerUrl("dojox.mobile.tests.doh.MblCSS3TransitionTests", require.toUrl("./MblCSS3TransitionTests.html"),999999);
		doh.registerUrl("dojox.mobile.tests.doh.CustomFixedBarsTests", require.toUrl("./CustomFixedBarsTests.html"),999999);
		doh.registerUrl("dojox.mobile.tests.doh.HeadingFixedBarsTests", require.toUrl("./HeadingFixedBarsTests.html"),999999);
