define(["dojo/main", "./_base", "./path"], function(dojo){
	var svg = dojo.getObject("gfx.svg", true, dojox),
		g = dojox.gfx, gs = g.shape;
	...
	dojo.declare("dojox.gfx.svg.Shape", gs.Shape, {
...
if (_measurementNode.getBBox)
	...
	dojo.declare("dojox.gfx.svg.Path", [svg.Shape, g.path.Path], {
		...
		_updateWithSegment: function(segment){
			...
			if(typeof(this.shape.path) == "string"){
				this.rawNode.setAttribute("dojo", this.shape.path);
			}
		},
		setShape: function(newShape){
			...
			if(this.shape.path){
				...
				this.rawNode.removeAttribute("dojo");
			}
			return this;	// self
		}
	});
	...
	dojo.declare("dojox.gfx.svg.TextPath", [svg.Shape, g.path.TextPath], {
		...
		_setTextPath: function(){
			...
			if(path){
				path.setAttribute("dojo", this.shape.path);
			}
		},
		_setText: function(){
			var r = this.rawNode;
	...
	dojo.extend(svg.Text, Font);
	dojo.extend(svg.TextPath, Font);

	dojo.extend(svg.Group, Container);
	dojo.extend(svg.Group, gs.Creator);
	dojo.extend(svg.Group, Creator);

	dojo.extend(svg.Surface, Container);
	dojo.extend(svg.Surface, gs.Creator);
	dojo.extend(svg.Surface, Creator);
		...
		var _eventsProcessing = {
			connect: function(name, object, method){
				...
				if (arguments.length == 2) {
					...
					method = dojo.hitch(object, method);
				}
