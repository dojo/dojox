...
dojo.declare("dojox.geo.openlayers.tests.ecr.PortRenderer", [ dojox.geo.openlayers.tests.ecr.EcrRenderer ], {
  ...
  _renderItem : function(o, item) {
    ...
    if (o.type == "circle") {
      ...
      var g = new dojox.geo.openlayers.Point({x:coords[0], y:coords[1]});
