define(["dojo/_base/kernel", "dojo/_base/declare", "dojox/mobile/IconContainer", "dojox/mobile/Button"],
	function(dojo, declare, ic, but){
		return dojo.declare("dojox.geo.openlayers.tests.mobile.goto.NavigationControl", [OpenLayers.Control], {
