...
dojo.provide("dojox.geo.openlayers.tests.mobile.simpleMap.NavigationControl");

dojo.require("dojox.mobile.IconContainer");
dojo.require('dojox.mobile.Button')

dojo.declare("dojox.geo.openlayers.tests.mobile.simpleMap.NavigationControl", [ OpenLayers.Control ], {
