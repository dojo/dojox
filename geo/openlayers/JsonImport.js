...
dojo.declare("dojox.geo.openlayers.JsonImport", null, {
	// summary:
	...
	_gotData : function(/* Object */items){
		...
		for ( var f in features) {
			...
			if (dojo.isArray(s[0])) {
				...
				var g = new dojox.geo.openlayers.Collection(a);
	...
	_makeGeometry : function(/* Array */s, /* Float */ulx, /* Float */uly, /* Float */lrx, /* Float */lry, /* Float */ulxLL, /* Float */ulyLL, /* Float */lrxLL, /* Float */lryLL){
		// summary:
		...
		var ls = new dojox.geo.openlayers.LineString(a);
		return ls;
	},

	_makeFeature : function(/* Array */s, /* Float */ulx, /* Float */uly, /* Float */lrx, /* Float */lry, /* Float */ulxLL, /* Float */ulyLL, /* Float */lrxLL, /* Float */lryLL){
		// summary:
		//   Make a GeometryFeature with the specified points.
		// tags:
		//   private
		var ls = this._makeGeometry(s, ulx, uly, lrx, lry, ulxLL, ulyLL, lrxLL, lryLL);
		var gf = new dojox.geo.openlayers.GeometryFeature(ls);
		return gf;
	},
