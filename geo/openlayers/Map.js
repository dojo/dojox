...
dojo.provide("dojox.geo.openlayers.Map");
...
dojo.declare("dojox.geo.openlayers.Map", null, {
	// summary:
	...
	constructor : function(div, options){
		...
		if (options.touchHandler)
			this._touchControl = new dojox.geo.openlayers.TouchInteractionSupport(map);
...
(function(){
	...
	dojox.geo.openlayers.Map.parseDMS = function(v, toDecimal){
		...
		// returns: 
		//   the parsed value in decimal degrees or an array ntaing the degrees, minutes, seconds values.
