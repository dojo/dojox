...
dojo.provide("dojox.geo.openlayers.widget.Map");

dojo.require("dojox.geo.openlayers.Map");
dojo.require("dojox.geo.openlayers.GfxLayer");
dojo.require("dijit._Widget");

dojo.declare("dojox.geo.openlayers.widget.Map", dijit._Widget, {
  //summary: 
  ...
  // With this widget, user can specify some attributes in the markup suach as
	...
	// * `toucHandler`: Tells if we attach touch handler or not.
	// 
	// example:
	//    
  ...
  // summary:
	...
	buildRendering : function(){
		...
		var map = new dojox.geo.openlayers.Map(div, {
