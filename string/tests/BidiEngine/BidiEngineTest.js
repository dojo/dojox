		...
		{	
			...
			runTest:function(t) {
				dojo.forEach(unilisrc, function(el, i) {
					t.is(uniliout[i], bdEngine.bidiTransform(el, 'ILYNN', 'VLNNN'),"bidiTransform: string num: " + i + " in: unilisrc out: uniliout");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(unirisrc, function(el, i) {
					t.is(uniriout[i], bdEngine.bidiTransform(el, 'IRYNN', 'VLNNN'),"bidiTransform: string num: " + i + " in: unirisrc out: uniriout");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(unilisrc, function(el, i) {
					t.is(unilisrc[i], bdEngine.bidiTransform(el, 'ILYNN', 'ILYNN'),"bidiTransform: string num: " + i + " in: unilisrc out: unilisrc");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(unilisrc, function(el, i) {
					t.is(unilisrc[i], bdEngine.bidiTransform(el, 'VLYNN', 'VLYNN'),"bidiTransform: string num: " + i + " in: unilisrc out: unilisrc");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(unilisrc, function(el, i) {
					t.is(unilicrs[i], bdEngine.bidiTransform(el, 'VLYNN', 'VRYNN'),"bidiTransform: string num: " + i + " in: unilisrc out: unilicrs");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(unilisrc, function(el, i) {
					t.is(unilicrs[i], bdEngine.bidiTransform(el, 'VRNNN', 'VLYNN'),"bidiTransform: string num: " + i + " in: unilisrc out: unilicrs");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(allcases[i], bdEngine.bidiTransform(el, 'VLNNN', 'VLNNN'),"bidiTransform: string num: " + i + " in: allcases out: allcases");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(allinvrs[i], bdEngine.bidiTransform(el, 'VRNNN', 'VLNNN'),"bidiTransform: string num: " + i + " in: allcases out: allinvrs");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(allinvrs[i], bdEngine.bidiTransform(el, 'VLNNN', 'VRNNN'),"bidiTransform: string num: " + i + " in: allcases out: allinvrs");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(allcases[i], bdEngine.bidiTransform(el, 'VRNNN', 'VRNNN'), "bidiTransform: string num: " + i + " in: allcases out: allcases");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(il2vlmdl[i], bdEngine.bidiTransform(el, 'ILYNN', 'VLNNN'), "bidiTransform: string num: " + i + " in: allcases out: il2vlmdl");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(ir2vlmdl[i], bdEngine.bidiTransform(el, 'IRYNN', 'VLNNN'), "bidiTransform: string num: " + i + " in: allcases out: ir2vlmdl");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(il2vrmdl[i], bdEngine.bidiTransform(el, 'ILYNN', 'VRNNN'), "bidiTransform: string num: " + i + " in: allcases out: il2vrmdl");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(ir2vrmdl[i], bdEngine.bidiTransform(el, 'IRYNN', 'VRNNN'), "bidiTransform: string num: " + i + " in: allcases out: ir2vrmdl");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(il2vlmdl[i], bdEngine.bidiTransform(el, 'VLNNN', 'ILYNN'), "bidiTransform: string num: " + i + " in: allcases out: il2vlmdl");
				},this);
			}		
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(vr2ilmdl[i], bdEngine.bidiTransform(el, 'VRNNN', 'ILYNN'), "bidiTransform: string num: " + i + " in: allcases out: vr2ilmdl");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(vl2irmdl[i], bdEngine.bidiTransform(el, 'VLNNN', 'IRYNN'), "bidiTransform: string num: " + i + " in: allcases out: vl2irmdl");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(ir2vrmdl[i], bdEngine.bidiTransform(el, 'VRNNN', 'IRYNN'), "bidiTransform: string num: " + i + " in: allcases out: ir2vrmdl");
				},this);
			}
		},
		{
			...
			runTest:function(t) {
				dojo.forEach(allcases, function(el, i) {
					t.is(allcases[i], bdEngine.bidiTransform(el, 'ILNNN', 'ILNNN'), "bidiTransform: string num: " + i + " in: allcases out: allcases");
				},this);
			}
		}
	]);
