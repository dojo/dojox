...
], function(declare, lang, Deferred, getPlainValue, EditModelRefControllerMixin, StoreRefControllerMixin){
	return declare("dojox.mvc.EditStoreRefControllerMixin", [StoreRefControllerMixin, EditModelRefControllerMixin], {
		// summary:
